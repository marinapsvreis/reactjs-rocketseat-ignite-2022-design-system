...
} from "./chunk-CNGZUFAZ.js";
import {
  __commonJS,
  __toESM as __toESM2
} from "./chunk-MFCSO543.js";
import {
...
// ../../node_modules/@storybook/components/dist/chunk-OLF4PGGZ.mjs
...
var GlobalScrollAreaStyles = (0, import_react.lazy)(() => import("./GlobalScrollAreaStyles-XIHNDKUY-E4VKQTH4.js"));
var OverlayScrollbars = (0, import_react.lazy)(() => import("./OverlayScrollbars-VAV6LJAB-A5N3G23Z.js"));
var Scroller = ({ horizontal, vertical, ...props }) => import_react.default.createElement(import_react.Suspense, { fallback: import_react.default.createElement("div", { ...props }) }, import_react.default.createElement(GlobalScrollAreaStyles, null), import_react.default.createElement(OverlayScrollbars, { options: { scrollbars: { autoHide: "leave" } }, ...props }));
var ScrollArea = emotion_styled_browser_esm_default(Scroller)(({ vertical }) => vertical ? { overflowY: "auto", height: "100%" } : { overflowY: "hidden" }, ({ horizontal }) => horizontal ? { overflowX: "auto", width: "100%" } : { overflowX: "hidden" });
...
var Wrapper = emotion_styled_browser_esm_default.div(({ theme }) => ({ position: "relative", overflow: "hidden", color: theme.color.defaultText }), ({ theme, bordered }) => bordered ? { border: `1px solid ${theme.appBorderColor}`, borderRadius: theme.borderRadius, background: theme.background.content } : {}, ({ showLineNumbers }) => showLineNumbers ? { ".react-syntax-highlighter-line-number::before": { content: "attr(data-line-number)" } } : {});
...
var Scroller2 = emotion_styled_browser_esm_default(UnstyledScroller)({ position: "relative" }, ({ theme }) => themedSyntax(theme));
var Pre = emotion_styled_browser_esm_default.pre(({ theme, padded }) => ({ display: "flex", justifyContent: "flex-start", margin: 0, padding: padded ? theme.layoutMargin : 0 }));
var Code = emotion_styled_browser_esm_default.div(({ theme }) => ({ flex: 1, paddingLeft: 2, paddingRight: theme.layoutMargin, opacity: 1 }));
...
//# sourceMappingURL=chunk-Y2IZS75X.js.map
